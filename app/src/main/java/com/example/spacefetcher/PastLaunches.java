...
public class PastLaunches {
    ...
    public PastLaunches(String image_patch_link, String flight_number, String mission_name, String rocket_name, String customer, String launch_site, String launch_date, String upcoming) {
